...
printf OUT "# Schmidt et al. Prediction of neo-epitope immunogenicity reveals TCR recognition determinants and immunoediting in human cancer. Cell Reports Medicine, 2021.\n";
printf OUT "#\n";
printf OUT "####################\n";
